  ...
  Future<PaymentResult> initiatePayment({
    ...
    try {
      ...
      final Map<String, dynamic> data = {
        ...
        BankAlfalahConstants.transactionReferenceNumberKey: request.orderId,
        BankAlfalahConstants.requestVerificationTokenKey: '',
        BankAlfalahConstants.transactionAmountKey: request.amount,
        BankAlfalahConstants.transactionTypeIdKey: request.orderId,
      };
      ...
      if (_config.debugMode) {
        final responseJson = const JsonEncoder.withIndent('  ').convert(data);

        log('Bank Alfalah Payment - Request Data: $responseJson');
      }
