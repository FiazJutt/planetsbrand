    ...
    showModalBottomSheet(
      ...
      builder:
          (context) => DistanceFilterBottomSheet(
            distanceOptions: shopController.distanceOptions,
            selectedDistance: shopController.selectedDistance.value,
            onDistanceSelected: (distance) {
              shopController.updateDistanceFilter(distance);
            },
          ...
          IconButton(
            icon: Stack(
              children: [
                ...
                if (shopController.selectedDistance.value > 0)
                  Positioned(
                    right: 0,
                    top: 0,
                    child: Container(
            ...
            : RefreshIndicator(
              ...
              child: Column(
                children: [
                  ...
                  Obx(() {
                    return shopController.selectedDistance.value > 0
                        ? Container(
                          ...
                          child: Row(
                            children: [
                              Container(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    ...
                                    Text(
                                      "Within ${shopController.selectedDistance.value}km",
                                      style: GoogleFonts.montserrat(
                                        fontSize: 12,
                                        fontWeight: FontWeight.w500,
                                        color: AppColors.green,
                              ...
                              Text(
                                "${shopController.filteredShops.length} shops found",
                                style: GoogleFonts.montserrat(
                                  fontSize: 12,
                                  color: AppColors.hintColor,
                                ),
