class GroceryStallsModel {
  int? statusCode;
  int? status;
  List<StallData>? data;
  int? currentPage; // Add this line
  int? lastPage; // Add this line
  int? total; // Add this line
  int? perPage; // Add this line
  ...
  GroceryStallsModel.fromJson(Map<String, dynamic> json) {
    statusCode = json['status_code'];
    status = json['status'];
    if (json['data'] != null) {
      data = <StallData>[];
      json['data'].forEach((v) {
        data!.add(StallData.fromJson(v));
      });
    }
    currentPage = json['current_page']; // Add this line
    lastPage = json['last_page']; // Add this line
    total = json['total']; // Add this line
    perPage = json['per_page']; // Add this line
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    data['current_page'] = currentPage; // Add this line
    data['last_page'] = lastPage; // Add this line
    data['total'] = total; // Add this line
    data['per_page'] = perPage; // Add this line
    return data;
  }
}
...
class StallData {
  ...
  StallData.fromJson(Map<String, dynamic> json) {
    id = json['id'];
