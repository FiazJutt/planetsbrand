...
class DealOfDayScreen extends StatelessWidget {
  DealOfDayScreen({super.key});
    ...
    return Scaffold(
      ...
      body: Obx(() {
        return homeController.loader.value
            ? CommonShimmerEffect()
            : homeController.dealProductModel.value?.data == null &&
                ...
                children: [
                  Expanded(
                    child: GridView.builder(
                      ...
                      itemCount:
                          homeController.dealProductModel.value?.data?.length ??
                          0,
