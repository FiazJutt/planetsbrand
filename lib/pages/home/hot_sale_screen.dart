    ...
    return Scaffold(
      ...
      body: Obx(() {
        return homeController.loader.value
            ? CommonShimmerEffect()
            : homeController.hotProductModel.value?.data == null &&
                homeController.hotProductModel.value!.data!.isEmpty
                ...
                children: [
                  Expanded(
                    child: GridView.builder(
                      ...
                      itemCount:
                          homeController.hotProductModel.value?.data?.length ??
                          0,
