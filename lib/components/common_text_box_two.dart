...
class CommonTextBoxTwo extends StatefulWidget {
  ...
  @override
  _CommonTextBoxTwoState createState() => _CommonTextBoxTwoState();
}

class _CommonTextBoxTwoState extends State<CommonTextBoxTwo> {
